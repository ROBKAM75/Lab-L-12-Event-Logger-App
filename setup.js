...
// Read server private key from .env (real key), fall back to .env.example
let serverKey = null
const envToRead = fs.existsSync(envPath) ? envPath : examplePath
if (fs.existsSync(envToRead)) {
  const content = fs.readFileSync(envToRead, 'utf8')
